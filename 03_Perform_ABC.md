...
These steps are implemented in [ABC_scripts/ABC00_merge_sims_remove_failed_v6.R](https://github.com/jordanbemmels/kiwi-iDDC/tree/main/ABC_scripts/ABC00_merge_sims_remove_failed_v6.R). The file-organization system is described in the file, but other users will likely need to substantially edit this file depending on their own file organization and output from the HPC cluster.
